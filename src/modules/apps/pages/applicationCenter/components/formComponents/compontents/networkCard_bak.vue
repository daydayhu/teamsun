    ...
    <section v-if="cidrList.length !== 0">
        <div v-for="(list,index) in cidrList" :key="index">
            <el-form-item label="IP">
                ...
                <el-button type="text" @click="enableNat(index)">
...
export default {
    ...
    methods: {
        ...
        getCidrList() {
            this.cidrList = []
            //通过CIDR筛选出可用IP列表
            requestMethod.getNodeCidrs("get",this.canvasObj.app_id,this.canvasObj.ticket_id,this.canvasObj.service_uuid).then(res=>{
