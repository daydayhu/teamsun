            ...
            <el-tree
                ...
                <div class="treeNode" slot-scope="{ node, data }">
                    ...
                    <div class="btnC">
                        ...
                        <el-button
                                type="text"
                                @click.stop="showTreeDialog(data, 'add')" v-if="node.level === 1 && false">
      ...
      getBaseDataForType() {
        ...
        requestMethod.getBaseDataForType('get',param).then(res => {
          if (res.code === 200) {
            ...
            this.productNodeTree = this.filterData(originTree[0].children)
            this.rootData = {
